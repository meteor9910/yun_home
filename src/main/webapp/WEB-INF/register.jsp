...
<%--                <span id="mask_body_item_getcode" class="baseColorFt disabled">60s后重新获取</span>--%>
            </div>
            ...
            <div class="mask_body_item">
                <input class="pop_input" type="password" autocomplete="new-password" name="password" placeholder="密码" onblur="checkPassword()" id="password">
